 ...
 * @date 2022-07-10
 */
public class MyTaskReview extends BaseEntity
{
    ...
    /** 工作总结信息 */
    private List<TaskReview> taskReviewList;
    ...
    public List<TaskReview> getTaskReviewList()
    {
        return taskReviewList;
    }

    public void setTaskReviewList(List<TaskReview> taskReviewList)
    {
        this.taskReviewList = taskReviewList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("taskReviewList", getTaskReviewList())
            .toString();
    }
}
