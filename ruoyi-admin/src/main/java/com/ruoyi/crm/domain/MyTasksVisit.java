 ...
 * @date 2022-07-10
 */
public class MyTasksVisit extends BaseEntity
{
    ...
    @Excel(name = "任务计划&总结(TASK_REVIEW) 关联")
    ...
    @Excel(name = "创建任务时间", width = 30, dateFormat = "yyyy-MM-dd")
    ...
    /** 陌生拜访信息 */
    private List<CrmTaskReviewStrange> crmTaskReviewStrangeList;
    ...
    public List<CrmTaskReviewStrange> getCrmTaskReviewStrangeList()
    {
        return crmTaskReviewStrangeList;
    }

    public void setCrmTaskReviewStrangeList(List<CrmTaskReviewStrange> crmTaskReviewStrangeList)
    {
        this.crmTaskReviewStrangeList = crmTaskReviewStrangeList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("crmTaskReviewStrangeList", getCrmTaskReviewStrangeList())
            .toString();
    }
}
