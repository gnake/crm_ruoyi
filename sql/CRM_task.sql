...
(
    ...
    TC_BEGIN    DATE COMMENT '起始日期',
    TC_END      DATE COMMENT '结束日期',
    PRIMARY KEY (TC_ID)
...
(
    ...
    TASK_CREATE_TIME    DATE COMMENT '创建任务时间',
    TASK_FINISH_TIME    DATE COMMENT '任务完成时间',
...
(
    ...
    ORDER_CREATE_TIME       DATE COMMENT '创建时间',
    ORDER_CONFIRM_PERSON    CHAR(36) COMMENT '确认人',
    ORDER_CONFIRM_TIME      DATE COMMENT '确认时间',
